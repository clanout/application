...
public class GcmHelper
{
    ...
    private static final String GCM_URL = "https://gcm-http.googleapis.com/gcm";
    private static final String GCM_KEY = ConfLoader.getConf(NotificationConf.GCM).get("api_key");
